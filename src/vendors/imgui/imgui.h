...
namespace ImGui
{
	...
	IMGUI_API void			PrettyDragFloat(const char* label, float* v, float min = 0, float max = 0, float labelWidth = 100.0f);
	IMGUI_API void			PrettyDragFloat3(const char* label, float v[3], float resetValue = 0.0f, float labelWidth = 100.0f);
